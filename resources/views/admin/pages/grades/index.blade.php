...
@section('title', 'Grades | Exam Settings')
    ...
    <div class="dashboard-main-body">
        ...
        <div class="card basic-data-table">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title mb-0">All School Grades</h5>
                        ...
                        <tbody>
                            @foreach ($grades as $index => $grade)
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin.grades.edit', $grade->id) }}"
                                            class="text-primary-600">{{ $grade->grade_name }}</a></td>
