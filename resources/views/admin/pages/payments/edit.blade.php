            ...
            <form action="{{ route('admin.payments.update', $payment->id) }}" method="POST" autocomplete="off">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 mb-20 position-relative" style="z-index: 9;">
                        ...
                        <input
                            type="text"
                            class="form-control radius-8 @error('student_name') is-invalid @enderror"
                            id="student_name"
                            name="student_name"
                            placeholder="Type student name (first middle last)"
                            autocomplete="off"
                            value="{{ old('student_name', $payment->student ? $payment->student->full_name : '') }}"
                            required
                        >
                    ...
                    <div class="col-sm-6 mb-20">
                        ...
                        <input type="number"
                               class="form-control radius-8 @error('amount_paid') is-invalid @enderror"
                    ...
                    <div class="col-sm-6 mb-20">
                        ...
                        <input type="date"
                               class="form-control radius-8 @error('payment_date') is-invalid @enderror"
                    ...
                    <div class="col-sm-6 mb-20">
                        ...
                        <input type="text"
                               class="form-control radius-8 @error('purpose') is-invalid @enderror"
                               id="purpose" name="purpose" placeholder="Enter Purpose"
                    ...
                    <div class="col-sm-6 mb-20">
                        ...
                        <input type="number"
                               class="form-control radius-8 @error('balance') is-invalid @enderror"
                               id="balance" name="balance" placeholder="Enter Balance"
                    ...
                    <div class="col-sm-6 mb-20">
                        ...
                        <input type="text"
                               class="form-control radius-8 @error('paid_by') is-invalid @enderror"
                    ...
                    <div class="col-sm-6 mb-20">
                        ...
                        <input type="text"
                               class="form-control radius-8 @error('received_by') is-invalid @enderror"
                    ...
                    <div class="col-sm-3 mb-20">
                        ...
                        <input type="text" class="form-control radius-8"
                               ...
                               value="{{ old('session', $payment->session ?? ($schoolinfo->current_session ?? '')) }}" readonly>
                    </div>
                    ...
                    <div class="col-sm-3 mb-20">
                        ...
                        <input type="text" class="form-control radius-8"
                               id="term" name="term"
                               value="{{ old('term', $payment->term ?? ($schoolinfo->current_term ?? '')) }}" readonly>
                    </div>
                    ...
                    <div class="col-sm-12 mb-20">
                        ...
                        <textarea name="notes" id="notes"
                            class="form-control radius-8 @error('notes') is-invalid @enderror"
                            placeholder="Enter any notes">{{ old('notes', $payment->notes) }}</textarea>
                        @error('notes')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mt-20">
                    <button type="submit" class="btn btn-primary radius-8 px-24 py-12">Save Changes</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    $(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (Array.isArray(data) && data.length) {
                            ...
                            $suggestions.html('<div class="autocomplete-suggestion text-muted">No matches found</div>').show();
                        }
                    }
                });
            }, 210);
        ...
        $input.on('blur', function () {
            setTimeout(function () { $suggestions.hide().empty(); }, 175);
        });
