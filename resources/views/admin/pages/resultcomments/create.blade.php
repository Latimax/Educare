    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            ...
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Create Comment</li>
            </ul>
        </div>

        <div class="card basic-data-table">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title mb-0">Create Comment</h5>
            ...
            <div class="card-body">
                <!-- Create Comment Form -->
                <form action="{{ route('admin.resultcomments.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-20">
                            ...
                            <textarea class="form-control radius-8 @error('comment') is-invalid @enderror" id="comment" name="comment"
                                placeholder="Enter Comment" rows="4">{{ old('comment') }}</textarea>
