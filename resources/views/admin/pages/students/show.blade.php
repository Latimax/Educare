    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            ...
            <div class="d-flex flex-wrap gap-2">
                <a href="{{ route('admin.students.edit', $student->id) }}" class="btn btn-primary">Edit Profile</a>

                <form action="{{ route('admin.advanced.promote.single', $student->id) }}" method="POST" class="advanced">
                    @csrf
                    <button type="submit" class="btn btn-success">Promote</button>
                </form>

                <form action="{{ route('admin.advanced.demote.single', $student->id) }}" method="POST" class="advanced">
                    @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2 align-items-center">
                                                    <form
                                                        action="{{ route('admin.advanced.promote.student', $promotion->id) }}"
                                                        method="POST" class="form-delete">
                                                        @csrf
                                                        @method('POST')
                                                        <input type="hidden" name="previous_id"
                                                            value="{{ $promotion->previous_class_id }}">
                                                        <input type="hidden" name="student_id"
                                                            value="{{ $promotion->student_id }}">
                                                        <button type="submit"
                                                            class="btn btn-sm btn-warning">Revert</button>
                                                    </form>

                                                    <a href="{{ route('admin.advanced.promote.delete', $promotion->id) }}"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.delete-btn').on('click', function(e) {
                ...
                const url = $(this).attr('href'); // Get the delete URL
