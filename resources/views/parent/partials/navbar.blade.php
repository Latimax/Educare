                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu to-top dropdown-menu-lg p-0">
                        ...
                        <div class="max-h-400-px overflow-y-auto scroll-sm pe-4">
                            ...
                            <!-- Other notifications -->
                            <!-- Similarly update the image sources here as well -->
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu to-top dropdown-menu-sm">
                        <div
                            ...
                            <div>
                                <h6 class="text-lg text-primary-light fw-semibold mb-2">{{ Auth::guard('parent')->user()->fullname }}</h6>
                                <span class="text-secondary-light fw-medium text-sm">Parent</span>
                            </div>
                        ...
                        <ul class="to-top-list">
                            ...
                            <li>
                                <form action="{{ route('parent.auth.logout') }}" method="post">
                                    @csrf
                                    <button type="submit"
