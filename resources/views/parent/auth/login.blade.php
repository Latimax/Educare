        ...
        <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
            <div class="max-w-464-px mx-auto w-100">
                <div>
                    ...
                    <p class="mb-32 text-secondary-light text-lg">Welcome back dear parent! please enter your detail</p>
                </div>
                @if(session('status'))
                ...
                <form method="POST" action="{{ route('parent.login') }}">
                    ...
                    <div class="icon-field mb-16">
                        ...
                        <input type="text" name="email" class="form-control h-56-px bg-neutral-50 radius-12 @error('email') is-invalid @enderror" placeholder="Email/Phone Number" value="{{ old('email') }}" autofocus>
                    </div>
                    @error('email')
