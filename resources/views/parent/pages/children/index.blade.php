...
@section('title', 'Children | All Children')
...
@section('content')
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Children</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium"> Children</li>
            </ul>
        </div>
                        ...
                        <tbody>
                            @foreach ($children as $student)
                                <tr>
                                    ...
                                    <td><a href="{{ route('parent.children.show', $student->id) }}" class="text-primary-600"> {{ $student->firstname }} {{ $student->lastname }}</a></td>
                                    ...
                                    <td class="d-flex gap-2 align-items-center">
                                        <a href="{{ route('parent.children.show', $student->id) }}"
