{{-- resources/views/staff/pages/cbt-configuration.blade.php --}}
                                ...
                                <div class="col-sm-6 border-1 p-24 radius-8">
                                    ...
                                    @foreach ($junior_subjects as $subject)
                                        <div class="mb-20 d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <a href="{{ route('staff.cbtquestions.subjects.view', ['subjectId' => $subject->id, 'className' => 'Junior Secondary 1']) }}"
                                                    class="badge bg-danger">Jss 1 [{{ $subject->jss1_questions_count }}]</a>
                                                <a href="{{ route('staff.cbtquestions.subjects.view', ['subjectId' => $subject->id, 'className' => 'Junior Secondary 2']) }}" class="badge bg-success">Jss 2
                                                    [{{ $subject->jss2_questions_count }}]</a>
                                                <a href="{{ route('staff.cbtquestions.subjects.view', ['subjectId' => $subject->id, 'className' => 'Junior Secondary 3']) }}" class="badge bg-info">Jss 3
                                ...
                                <div class="col-sm-6 border-1 p-24 radius-8">
                                    ...
                                    @foreach ($senior_subjects as $subject)
                                        <div class="mb-20 d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <a href=" {{ route('staff.cbtquestions.subjects.view', ['subjectId' => $subject->id, 'className' => 'Senior Secondary 1']) }}" class="badge bg-danger">Sss 1
                                                    [{{ $subject->sss1_questions_count }}]</a>
                                                <a href="{{ route('staff.cbtquestions.subjects.view', ['subjectId' => $subject->id, 'className' => 'Senior Secondary 2']) }}" class="badge bg-success">Sss 2
                                                    [{{ $subject->sss2_questions_count }}]</a>
                                                <a href="{{ route('staff.cbtquestions.subjects.view', ['subjectId' => $subject->id, 'className' => 'Senior Secondary 3']) }}" class="badge bg-info">Sss 3
...
@push('scripts')
    ...
    <script>
        ...
        $(document).on('change', '.form-check-input[data-subject-toggle]', function() {
            ...
            $.ajax({
                url: '/staff/cbtconfig/subject-toggle',
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
