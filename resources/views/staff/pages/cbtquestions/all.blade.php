        ...
        <div class="card basic-data-table">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('staff.cbtquestions.index') }}"
                    ...
                    <a href="{{ route('staff.cbtquestions.subjects.create', ['subjectId' => $subjectId, 'classId' => $classId]) }}"
                            ...
                            @foreach ($questions as $question)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('staff.cbtquestions.edit', $question->id) }}"
                                            class="btn btn-sm btn-primary">Edit</a>
                                        <form action="{{ route('staff.cbtquestions.destroy', $question->id) }}"
