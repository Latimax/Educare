...
@section('content')
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Edit Student Result - {{ $schoolinfo->name ?? 'School' }}</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Edit Result</li>
            </ul>
        </div>

        <div class="card basic-data-table">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title mb-0">Edit Student Result</h5>
            ...
            <div class="card-body">
                <form action="{{ route('staff.studentresults.update', $result->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 mb-20">
                            ...
                            <input type="text" class="form-control"
                                value="{{ \App\Models\Student::find($result->student_id)->firstname ?? '' }} {{ \App\Models\Student::find($result->student_id)->lastname ?? '' }} {{ \App\Models\Student::find($result->student_id)->middlename ?? '' }}"
                                readonly>
                        ...
                        <div class="col-sm-3 mb-20">
                            ...
                            <input type="number" class="form-control @error('total_time_present') is-invalid @enderror"
                                name="total_time_present" value="{{ old('total_time_present', $result->total_time_present) }}"
                    ...
                    <div class="row">
                        <div class="col-sm-6 mb-20">
                            ...
                            <input type="text" class="form-control" value="{{ ucfirst($result->term) }}" readonly>
                        ...
                        <div class="col-sm-6 mb-20">
                            ...
                            <input type="text" class="form-control" value="{{ $result->session }}" readonly>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th>Subject</th>
                                    <th>First Test ({{ $level_config->ft_max_score ?? 20 }})</th>
                                    <th>Second Test ({{ $level_config->st_max_score ?? 20 }})</th>
                                    <th>Exam ({{ $level_config->exam_max_score ?? 60 }})</th>
                                    <th>Total</th>
                                    <th>Grade</th>
                                    <th>Offer Subject</th>
                                </tr>
                                    ...
                                    <tr class="subject-row" data-subject-id="{{ $subject->id }}">
                                        ...
                                        <td>
                                            <input type="number" class="form-control first-test"
                                                ...
                                                min="{{ $level_config->ft_min_score ?? 0 }}"
                                                max="{{ $level_config->ft_max_score ?? 20 }}"
                                                value="{{ old('scores.' . $subject->id . '.first_test', $score['first_test']) }}">
                                        ...
                                        <td>
                                            <input type="number" class="form-control second-test"
                                                ...
                                                min="{{ $level_config->st_min_score ?? 0 }}"
                                                max="{{ $level_config->st_max_score ?? 20 }}"
                                                value="{{ old('scores.' . $subject->id . '.second_test', $score['second_test']) }}">
                                        ...
                                        <td>
                                            <input type="number" class="form-control exam"
                                                ...
                                                min="{{ $level_config->exam_min_score ?? 0 }}"
                                                max="{{ $level_config->exam_max_score ?? 60 }}"
                                                value="{{ old('scores.' . $subject->id . '.exam', $score['exam']) }}">
                                        ...
                                        <td>
                                            <input type="text" class="form-control total"
                                                ...
                                                value="{{ old('scores.' . $subject->id . '.total', $score['total']) }}"
                                                max="100">
                                        ...
                                        <td>
                                            <input type="text" class="form-control grade"
                                                ...
                                                value="{{ old('scores.' . $subject->id . '.grade', $score['grade']) }}">
                                        ...
                                        <td>
                                            <input type="checkbox" class="form-check-input offer-subject"
                                                ...
                                                {{ old('scores.' . $subject->id . '.offer', $score['offer'] ?? true) ? 'checked' : '' }}>
                    ...
                    <div class="row mt-4">
                        <div class="col-sm-3 mb-20">
                            ...
                            <input type="text" class="form-control" id="first_test_total" readonly
                                value="{{ old('first_test_total', $result->resultData['summary']['first_test_total'] ?? 0) }}">
                        ...
                        <div class="col-sm-3 mb-20">
                            ...
                            <input type="text" class="form-control" id="second_test_total" readonly
                                value="{{ old('second_test_total', $result->resultData['summary']['second_test_total'] ?? 0) }}">
                        ...
                        <div class="col-sm-3 mb-20">
                            ...
                            <input type="text" class="form-control" id="exam_total" readonly
                                value="{{ old('exam_total', $result->resultData['summary']['exam_total'] ?? 0) }}">
                            @error('exam_total')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-sm-3 mb-20">
                            ...
                            <input type="text" name="overall_total" class="form-control" id="overall_total" readonly
                                value="{{ old('overall_total', $result->resultData['summary']['overall_total'] ?? 0) }}">
                            @error('overall_total')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                                            ...
                                            @foreach (['excellent', 'good', 'fair', 'poor', 'v_poor'] as $value)
                                                <td>
                                                    <input type="radio"
                                                        ...
                                                        {{ old($field . '.' . $field, $result->$field ?? 'fair') === $value ? 'checked' : '' }}>
                                                </td>
                                            @endforeach
                                        </tr>
                                        @error($field . '.' . $field)
                    ...
                    <div class="row">
                        <div class="col-sm-3 mb-20">
                            ...
                            <input type="text" class="form-control" id="noofsubjectpass" name="noofsubjectpass"
                                readonly value="{{ old('noofsubjectpass', $result->noofsubjectpass ?? 0) }}">
                        ...
                        <div class="col-sm-3 mb-20">
                            ...
                            <input type="text" class="form-control" id="average" name="average" readonly
                                value="{{ old('average', $result->average ?? $result->resultData['summary']['average'] ?? 0) }}">
                            @error('average')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-sm-3 mb-20">
                            ...
                            <input type="text" class="form-control" id="grade" name="grade" readonly
                                value="{{ old('grade', $result->resultData['summary']['grade'] ?? '') }}">
                            @error('grade')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-sm-3 mb-20">
                            ...
                            <input type="text" class="form-control" id="conduct" name="conduct" readonly
                                value="{{ old('conduct', $result->conduct ?? '') }}">
                            @error('conduct')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                            ...
                            <select name="class_teacher_comment" id="class_teacher_comment"
                                ...
                                @foreach ($comments as $comment)
                                    <option value="{{ $comment->id }}"
                                        {{ old('class_teacher_comment', $result->class_teacher_comment) == $comment->id ? 'selected' : '' }}>
                                        {{ $comment->comment }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-sm-6 mb-20">
                            ...
                            <select name="principal_comment" id="principal_comment"
                                ...
                                @foreach ($comments as $comment)
                                    <option value="{{ $comment->id }}"
                                        {{ old('principal_comment', $result->principal_comment) == $comment->id ? 'selected' : '' }}>
                                        {{ $comment->comment }}
                                    </option>
                                @endforeach
                            </select>
