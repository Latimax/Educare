                    ...
                    <div class="row">
                        <div class="col-12 mb-20">
                            @if (isset($subjects) || isset($classes))
                                <a href="{{ route('staff.examquestions.index') }}"
                    ...
                    <div class="col-xxl-6">
                        <div class="card p-0 overflow-hidden position-relative radius-12 h-100">
                            <div class="card-header py-16 px-24 bg-base border border-end-0 border-start-0 border-top-0">
                                <h6 class="text-lg mb-0">Subjects for {{ $className }}</h6>
                            </div>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="tab-content flex-grow-1" id="subject-tabContent">
                                        <div class="tab-pane fade show active" id="subject-content" role="tabpanel"
                                            ...
                                            <form method="POST" action="{{ route('staff.examquestions.subjects.save') }}"
    ...
    <script>
            ...
            tinymce.init({
                ...
                images_upload_handler: function(blobInfo, progress) {
                    return new Promise((resolve, reject) => {
                        ...
                        xhr.open('POST', '/staff/examquestions/question/upload-image');
        ...
        $(document).ready(function() {
            ...
            function fetchClassName(classId) {
                $.ajax({
                    url: '/staff/examquestions/classes/' + classId + '/name',
                    method: 'GET',
                    headers: {
            ...
            $('#subject-tab .nav-link').on('click', function() {
                ...
                $.ajax({
                    url: '/staff/examquestions/subjects/' + subjectId + '/' + classId + '/content',
                    method: 'GET',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
